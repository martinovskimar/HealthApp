...
@javax.annotation.Generated(
    ...
    comments = "Source: S1-userLogin.proto")
public final class userLoginGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.service1.LoginRequest,
      grpc.service1.LoginResponse> getLoginMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Login",
      requestType = grpc.service1.LoginRequest.class,
      responseType = grpc.service1.LoginResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.service1.LoginRequest,
      grpc.service1.LoginResponse> getLoginMethod() {
    io.grpc.MethodDescriptor<grpc.service1.LoginRequest, grpc.service1.LoginResponse> getLoginMethod;
      ...
      synchronized (userLoginGrpc.class) {
        if ((getLoginMethod = userLoginGrpc.getLoginMethod) == null) {
          userLoginGrpc.getLoginMethod = getLoginMethod = 
              io.grpc.MethodDescriptor.<grpc.service1.LoginRequest, grpc.service1.LoginResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "userLogin", "Login"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.service1.LoginRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.service1.LoginResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.service1.LogoutRequest,
      grpc.service1.LogoutResponse> getLogoutMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Logout",
      requestType = grpc.service1.LogoutRequest.class,
      responseType = grpc.service1.LogoutResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.service1.LogoutRequest,
      grpc.service1.LogoutResponse> getLogoutMethod() {
    io.grpc.MethodDescriptor<grpc.service1.LogoutRequest, grpc.service1.LogoutResponse> getLogoutMethod;
    if ((getLogoutMethod = userLoginGrpc.getLogoutMethod) == null) {
      synchronized (userLoginGrpc.class) {
        if ((getLogoutMethod = userLoginGrpc.getLogoutMethod) == null) {
          userLoginGrpc.getLogoutMethod = getLogoutMethod = 
              io.grpc.MethodDescriptor.<grpc.service1.LogoutRequest, grpc.service1.LogoutResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "userLogin", "Logout"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.service1.LogoutRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.service1.LogoutResponse.getDefaultInstance()))
  ...
  public static abstract class userLoginImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void login(grpc.service1.LoginRequest request,
        io.grpc.stub.StreamObserver<grpc.service1.LoginResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getLoginMethod(), responseObserver);
    }

    /**
     */
    public void logout(grpc.service1.LogoutRequest request,
        io.grpc.stub.StreamObserver<grpc.service1.LogoutResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                grpc.service1.LoginRequest,
                grpc.service1.LoginResponse>(
                  this, METHODID_LOGIN)))
          .addMethod(
            getLogoutMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                grpc.service1.LogoutRequest,
                grpc.service1.LogoutResponse>(
  ...
  public static final class userLoginBlockingStub extends io.grpc.stub.AbstractStub<userLoginBlockingStub> {
    ...
    /**
     */
    public grpc.service1.LoginResponse login(grpc.service1.LoginRequest request) {
    ...
    /**
     */
    public grpc.service1.LogoutResponse logout(grpc.service1.LogoutRequest request) {
      return blockingUnaryCall(
  ...
  public static final class userLoginFutureStub extends io.grpc.stub.AbstractStub<userLoginFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.service1.LoginResponse> login(
        grpc.service1.LoginRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.service1.LogoutResponse> logout(
        grpc.service1.LogoutRequest request) {
      return futureUnaryCall(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOGIN:
          serviceImpl.login((grpc.service1.LoginRequest) request,
              (io.grpc.stub.StreamObserver<grpc.service1.LoginResponse>) responseObserver);
          break;
        case METHODID_LOGOUT:
          serviceImpl.logout((grpc.service1.LogoutRequest) request,
              (io.grpc.stub.StreamObserver<grpc.service1.LogoutResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class userLoginBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpc.service1.userLoginProto.getDescriptor();
    }
